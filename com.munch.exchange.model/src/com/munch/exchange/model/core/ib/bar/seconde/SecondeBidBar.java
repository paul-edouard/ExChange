...
@Entity
@IdClass(BarPK.class)
public class SecondeBidBar implements Serializable,Comparable<SecondeBidBar>,BarConversionInterface{
	...
	public SecondeBidBar() {
		super();
	}
	

	public SecondeBidBar(long time, double high, double low, double open,
	...
	@Override
	public int compareTo(SecondeBidBar o) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SecondeBidBar other = (SecondeBidBar) obj;
