...
@Entity
public class BullishTriStar extends Candlesticks {
	...
	public BullishTriStar() {
		super();
	}

	public BullishTriStar(IbChartIndicatorGroup group) {
		super(group);
	}
	...
	public IbChartIndicator copy() {
		IbChartIndicator c=new BullishTriStar();
		c.copyData(this);
		return c;
	}
