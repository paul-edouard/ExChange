...
@Entity
public class RevMaxProfitWithLimit extends IbChartSignal {
	...
	public static final String PARAM_MIN_PROFIT_LIMIT="Min Profit Limit";


	public RevMaxProfitWithLimit() {
		super();
	}

	public RevMaxProfitWithLimit(IbChartIndicatorGroup group) {
		super(group);
	}
	
	@Override
	public IbChartIndicator copy() {
		IbChartIndicator c=new RevMaxProfitWithLimit();
		c.copyData(this);
		return c;
	}
	...
	public void initName() {
		this.name= "Reverse Max Profit with min Profit Limit";
	}

	@Override
	public void createParameters() {
		this.parameters.add(new IbChartParameter(this, PARAM_PRICE,DataType.CLOSE.name(),DataType.toStringArray()));
		this.parameters.add(new IbChartParameter(this, PARAM_MIN_PROFIT_LIMIT,ParameterType.DOUBLE, 5, 0, 100, 1));
