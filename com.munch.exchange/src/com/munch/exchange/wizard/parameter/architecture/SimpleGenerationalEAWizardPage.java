...
public class SimpleGenerationalEAWizardPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		comboNullarySearchOperation.setText(AlgorithmParameters.NSO_MixNetworkCreation);
		...
		comboNullarySearchOperation.add(AlgorithmParameters.NSO_MixNetworkCreation);
