...
public class PrimeTestMO {
  ...
  public static final void main(final String[] args) {
    ...
    final SimpleGenerationalMOEA<IntFunction, IntFunction> EA;
    int i, j, k;
    ...
    create = new TreeRampedHalfAndHalf<IntFunction>(nts, 15);
    mutate = ((IUnarySearchOperation) (new TreeMutator(15)));
    crossover = ((IBinarySearchOperation) (new TreeRecombination(15)));

    EA = new SimpleGenerationalMOEA<IntFunction, IntFunction>();
    EA.setCrossoverRate(0.5);
    EA.setMutationRate(0.5);
    EA.setComparator(Pareto.PARETO_COMPARATOR);// Pareto.PARETO_COMPARATOR);
